...
class Database {
    ...
    public static function getConnection(): PDO {
        ...
        try {
            ...
            // Trace sur stderr (flux de logs de l'hébergeur) — index.php
            // redirige error_log() vers un fichier interne.
            @file_put_contents('php://stderr', '[KBF DB] connexion impossible : ' . $e->getMessage() . PHP_EOL);
